...
nmap 192.168.1.1-5 -PS22-25,80	            TCP SYN discovery on port x.
nmap 192.168.1.1-5 -PA22-25,80	            TCP ACK discovery on port x.
nmap 192.168.1.1-5 -PU53	                UDP discovery on port x.
...
nmap 192.168.1.1 -p0-	                    Leaving off end port in range
